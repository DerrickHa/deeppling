...
import { payrollPolicySchema } from "@deeppling/shared";
...
export async function POST(
  ...
  try {
    ...
    const payload = parseBody(payrollPolicySchema, body);
    const org = services.onboarding.setPayrollPolicy(id, principal.email, payload);
